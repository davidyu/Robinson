...
function StartOrbit() {
  if ( app == null ) {
    ...
    testScene.addRenderable( new Sphere( 1, new BlinnPhongMaterial( new gml.Vec4( 0.1, 0.1, 0.1, 1 ), new gml.Vec4( 0.5, 0.5, 0.5, 1 ), new gml.Vec4( 0.5, 0.5, 0.5, 1 ), new gml.Vec4( 0, 0, 0, 1 ), 20.0 ) ) );
    ...
    testScene.addLight( new PointLight( new gml.Vec4( 0, 9.0, 0, 1.0 ), new gml.Vec4( 0.0, 1.0, 0.0, 1.0 ) ) );
    testScene.addLight( new PointLight( new gml.Vec4( 0, 0, 9.0, 1.0 ), new gml.Vec4( 0.0, 0.0, 1.0, 1.0 ) ) );
  }
}
